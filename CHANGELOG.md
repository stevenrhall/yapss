...
- An Ipopt option that Ipopt refuses still warns, and the solve still continues with Ipopt's
  ...
  pinned Ipopt release) give the kind of each option and the hint, never a verdict. A type
  checker now reports a misspelled option name before the script runs.
