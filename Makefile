...
clean: ## Remove caches, and files generated by testing (including coverage) and generating documentation.
	...
	black src/yapss tests docs
# 88, not the 100 used everywhere else: a wider line gives the cell a horizontal
# scroll bar on Read the Docs, which hides the right-hand end of the line.
	black --line-length 88 examples/notebooks
