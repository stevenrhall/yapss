...
def solvable(method: str = "auto") -> Any:
    ...
    ph.state.bounds.x = (0.0, 10.0)
    ph.state.bounds.y = (0.0, 10.0)
    ph.state.bounds.v = (0.0, 10.0)
    ph.control.bounds.theta = (-1.6, 1.6)
    ph.path.bounds.speed = (0.0, 100.0)
    problem.discrete.bounds.drop = (0.5, 0.5)

    ph.time.guess = (0.0, 1.0)
    ph.state.guess.x = (0.0, 1.0)
    ph.state.guess.y = (0.0, 0.5)
    ph.state.guess.v = (0.0, 5.0)
    ph.control.guess.theta = (0.0, 0.0)
