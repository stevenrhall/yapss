...
Test that yapss._legacy.examples.goddard_problem_3_phase works properly.
...
# package imports
from yapss._legacy.examples import goddard_problem_3_phase as optimal_control_problem
...
def test_optimal_control_problem(method: str, mode: str, order: str) -> None:
    """Test the goddard_problem_3_phase example."""
